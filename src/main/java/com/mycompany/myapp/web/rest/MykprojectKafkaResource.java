...
@RestController
@RequestMapping("/api/mykproject-kafka")
public class MykprojectKafkaResource {

    private final Logger log = LoggerFactory.getLogger(MykprojectKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public MykprojectKafkaResource(KafkaProperties kafkaProperties) {
