...
//            new Jwt("tokenVal", Instant.now(), Instant.now().plus(Duration.ofMinutes(3)), new HashMap(){{put("alg", "HS256");}}, new HashMap(){{put("sub", SUB_VALUE);}})
//        );
...
//            new DefaultOidcUser(
//                new ArrayList(){{new SimpleGrantedAuthority("USER");}},
